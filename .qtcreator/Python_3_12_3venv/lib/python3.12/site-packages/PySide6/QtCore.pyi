...
class QObject(Shiboken.Object):
    ...
    def findChild(self, type: typing.Type[PlaceholderType], /, name: str = ..., options: PySide6.QtCore.Qt.FindChildOption = ...) -> PlaceholderType | None : ...
    @typing.overload
...
class QRangeModel(PySide6.QtCore.QAbstractItemModel):
    ...
    @typing.overload
    def __init__(self, data: collections.abc.Sequence[typing.Any], /, parent: PySide6.QtCore.QObject | None = ..., *, roleNames: typing.Dict[int, PySide6.QtCore.QByteArray] | None = ...) -> None: ...
    @typing.overload
    def __init__(self, list: collections.abc.Iterable, /, parent: PySide6.QtCore.QObject | None = ..., *, roleNames: typing.Dict[int, PySide6.QtCore.QByteArray] | None = ...) -> None: ...
